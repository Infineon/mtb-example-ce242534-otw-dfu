    ...
    ((CY_EXT_NVM1_BASE <= address) && (address < (CY_EXT_NVM1_BASE + CY_EXT_NVM1_SIZE)));
        CY_UNUSED_PARAMETER(params);
            ...
            addrValid = (blocks_sector_size > 0U);
                ...
                /* TODO: Use macros generated from Memory configurator when available */
                addrValid = (((CYMEM_CM33_0_S_sss_image_S_START) <= address) &&  //0x32040200-DFU MW, 0x3204C000- DFU EPT  
                            (address < (CYMEM_CM33_0_S_sss_image_S_START + CYMEM_CM33_0_S_sss_image_SIZE)));     //0x32050200-DFU MW, 0x32080000-DFU EPT
            #else
